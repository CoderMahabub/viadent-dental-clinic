            ...
            <Container>
                <Row>
                    ...
                    <Col className="d-flex flex-column mt-4">
                        <h3>Quick Links</h3>
                        <Link to="/home"><span className="text-info">{arrowRight} </span> Home</Link>
                        <Link to="/home#services"><span className="text-info">{arrowRight} </span> Services</Link>
                        <Link to="/about"><span className="text-info">{arrowRight} </span> About Us</Link>
                        <Link to="/about"><span className="text-info">{arrowRight} </span> About Us</Link>
                        <Link to="/contact"><span className="text-info">{arrowRight} </span> Contact Us</Link>
                    </Col>
                    <Col className="d-flex flex-column mt-4 text-start">
                        ...
                        <Button variant="info">+88017000000</Button>
                    </Col>
                </Row>
            </Container>
