    ...
    return (
        <div className="contact-us pb-3">
            <div className="contact-top">
                ...
                <p className="text-center w-responsive mx-auto mb-5 px-2">Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within a matter of hours to help you.</p>
