                ...
                <Card.Body className="text-start">
                    <div className="card mb-3">
                        ...
                        <div className="card-body">
                            <h3 className="card-title fw-bold">{user?.displayName}</h3>
                            <h6 className="card-title">{user?.email}</h6>
                            <div className="d-flex align-items-center justify-content-center">
                                <p className="card-text text-start px-3"><b>Patient Detail:</b>{patient.pDescription}</p>
                            ...
                            <h4><b>Doctor Name: </b>{patient.pDoctorName}</h4>
                        </div>
                    </div>
                </Card.Body>
